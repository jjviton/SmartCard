...
public class monederoBasic extends Applet {
  ...
  private monederoBasic (byte[] bArray, short bOffset, byte bLength){
  ...
  public static void install(byte[] bArray, short bOffset, byte bLength) {
    ...
    new monederoBasic(bArray, bOffset, bLength);
  ...
  private void debit(APDU apdu) {
    ...
    balance = (short) ((short)balance - (short)debitAmount);
  } // end of debit method
